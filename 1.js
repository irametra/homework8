...
*/
Так произошло, благодарю понятию - всплытия событий. Принцип всплытия заключается в том, что когда кликают по элементу, то сначала обработчик срабатывает на самом нижнем вложенном элементе в иерархии DOM структуры.
